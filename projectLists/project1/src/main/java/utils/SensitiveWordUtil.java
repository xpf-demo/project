...
public class SensitiveWordUtil {
	    ...
	    /**
	     * @param content 需要检验的字符串
	     * @param sensitiveWordSet  敏感词库
	     * @return
	     */
		public static boolean checkHasFire(String context, Set<String> sensitiveWordSet) {
	        //初始化敏感词库
	        init(sensitiveWordSet);
	        boolean result = contains(context);
			return result;
		}
		 ...
		 * @return
		 */
		public static String dealContext(String context) {
			return context.trim().replaceAll("\\*", "").replaceAll("#", "")
	   ...
	   public static void main(String[] args) {
		   	String mobile = "asdasdas15871025786asdasda";
		    //mobile = mobile.replaceAll("(\\d{3})\\d{4}(\\d{4})", "****");
		    
		    System.out.println(mobile);
		    System.out.println(mobile.matches(PHONE_REGEX));
		    System.out.println(dealContext("*操@@你%*%%妈"));
	    }
